                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-primary" href="#"><i class="mdi mdi-power font-size-16 align-middle me-2 text-primary"></i>
                                <span>Logout</span></a>
                        </div>
                    </div>
                                            ...
                                            <div class="inbox-wid">
                                                <a href="#" class="text-dark">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img float-start me-3"><img src="../images/users/avatar-1.jpg" class="avatar-md rounded-circle" alt=""></div>
                                                ...
                                                <a href="#" class="text-dark">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img float-start me-3"><img src="../images/users/avatar-2.jpg" class="avatar-md rounded-circle" alt=""></div>
                                                ...
                                                <a href="#" class="text-dark">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img float-start me-3"><img src="../images/users/avatar-3.jpg" class="avatar-md rounded-circle" alt=""></div>
                                                ...
                                                <a href="#" class="text-dark">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img float-start me-3"><img src="../images/users/avatar-4.jpg" class="avatar-md rounded-circle" alt=""></div>
                                                ...
                                                <a href="#" class="text-dark">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img float-start me-3"><img src="../images/users/avatar-5.jpg" class="avatar-md rounded-circle" alt=""></div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <ul class="nav nav-pills nav-justified recent-activity-tab mb-4" id="recent-activity-tab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="activity1-tab" data-bs-toggle="pill" href="#activity1" role="tab" aria-controls="activity1" aria-selected="true">21 Sep</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="activity2-tab" data-bs-toggle="pill" href="#activity2" role="tab" aria-controls="activity2" aria-selected="false">22 Sep</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="activity3-tab" data-bs-toggle="pill" href="#activity3" role="tab" aria-controls="activity3" aria-selected="false">23 Sep</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="activity4-tab" data-bs-toggle="pill" href="#activity4" role="tab" aria-controls="activity4" aria-selected="false">24 Sep</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                                            ...
                                            <table class="table table-hover align-middle mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <span class="peity-donut" data-peity='{ "fill": ["#35a989", "#f2f2f2"], "innerRadius": 20, "radius": 32 }' data-width="54" data-height="54">9,4</span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <span class="peity-donut" data-peity='{ "fill": ["#35a989", "#f2f2f2"], "innerRadius": 20, "radius": 32 }' data-width="54" data-height="54">20,4</span>
                                                            </div>
                                                        </td>
                                                        <td>
                                            ...
                                            <table class="table table-hover align-middle mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="../images/users/avatar-2.jpg" alt="" class="avatar-md rounded-circle me-2"> Jeanette
                                                                James
                                                            </div>
                                                        </td>
                                                        <td>14/8/2018</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="../images/users/avatar-3.jpg" alt="" class="avatar-md rounded-circle me-2"> Christopher
                                                                Taylor
                                                            </div>
                                                        </td>
                                                        <td>15/8/2018</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="../images/users/avatar-4.jpg" alt="" class="avatar-md rounded-circle me-2"> Edward
                                                                Vazquez
                                                            </div>
                                                        </td>
                                                        <td>15/8/2018</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="../images/users/avatar-5.jpg" alt="" class="avatar-md rounded-circle me-2"> Michael
                                                                Flannery
                                                            </div>
                                                        </td>
                                                        <td>16/8/2018</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="../images/users/avatar-6.jpg" alt="" class="avatar-md rounded-circle me-2"> Jamie
                                                                Fishbourne
                                                            </div>
                                                        </td>
                                                        <td>17/8/2018</td>
                                            ...
                                            <table class="table table-hover align-middle mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="../images/users/avatar-4.jpg" alt="" class="avatar-md rounded-circle me-2"> Matthew
                                                                Drapeau
                                                            </div>
                                                        </td>
                                                        <td>17/8/2018
                                                        ...
                                                        <td>$104</td>
                                                        <td><span class="badge bg-soft-success rounded-pill"><i class="mdi mdi-checkbox-blank-circle text-success"></i>
                                                                Delivered</span></td>
                                                        <td>
                                                            <div>
                                                                <a href="#" class="btn btn-primary btn-sm">Edit</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="../images/users/avatar-5.jpg" alt="" class="avatar-md rounded-circle me-2"> Ralph Shockey
                                                            </div>
                                                        </td>
                                                        <td>18/8/2018
                                                        ...
                                                        <td>$112</td>
                                                        <td><span class="badge bg-soft-warning rounded-pill"><i class="mdi mdi-checkbox-blank-circle text-warning"></i>
                                                                Pending</span></td>
                                                        <td>
                                                            <div>
                                                                <a href="#" class="btn btn-primary btn-sm">Edit</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="../images/users/avatar-6.jpg" alt="" class="avatar-md rounded-circle me-2"> Alexander
                                                                Pierson
                                                            </div>
                                                        </td>
                                                        <td>18//8/2018
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="../images/users/avatar-7.jpg" alt="" class="avatar-md rounded-circle me-2"> Robert Rankin
                                                            </div>
                                                        </td>
                                                        <td>19/8/2018
                                                        ...
                                                        <td>$109</td>
                                                        <td><span class="badge bg-soft-primary rounded-pill"><i class="mdi mdi-checkbox-blank-circle text-primary"></i>
                                                                Cancel</span></td>
                                                        <td>
                                                            <div>
                                                                <a href="#" class="btn btn-primary btn-sm">Edit</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <img src="../images/users/avatar-8.jpg" alt="" class="avatar-md rounded-circle me-2"> Myrna Shields
                                                            </div>
                                                        </td>
                                                        <td>20/8/2018
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            ...
                            </script> © Agroxa <span class="d-none d-sm-inline-block">- Crafted with <i class="mdi mdi-heart text-primary"></i> by
                                Themesbrand.</span>
                        </div>
